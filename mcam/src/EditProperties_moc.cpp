/****************************************************************************
** Meta object code from reading C++ file 'EditProperties.hpp'
**
...
#include "../include/EditProperties.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'EditProperties.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_EditProperties[] = {
    "EditProperties\0\0handleCancelButton()\0"
    "handleSetToDefaultButton()\0"
    "handleSaveButton()\0"
};
...
void EditProperties::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->handleCancelButton(); break;
        case 1: _t->handleSetToDefaultButton(); break;
