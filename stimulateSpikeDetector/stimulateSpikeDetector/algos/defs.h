...
#define GEN_ITERATIONS		3800   		// Number of iterations for genetic algorithm to convergate
...
#define NUM_RAND_ITERATIONS 400         // Number of iterations before replacing templates with lowest cost with new random templates (0=turned off)
...
#define ACTIVE_TEMPLATE		2			// Select active template 0-61
